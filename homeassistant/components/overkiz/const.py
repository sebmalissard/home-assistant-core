...
OVERKIZ_DEVICE_TO_PLATFORM: dict[UIClass | UIWidget, Platform | None] = {
    ...
    UIWidget.ATLANTIC_ELECTRICAL_TOWEL_DRYER: Platform.CLIMATE,
    UIWidget.ATLANTIC_HEAT_RECOVERY_VENTILATION: Platform.CLIMATE,
    UIWidget.ATLANTIC_PASS_APC_DHW: Platform.WATER_HEATER,
    UIWidget.ATLANTIC_PASS_APC_HEAT_PUMP: Platform.CLIMATE,
    UIWidget.ATLANTIC_PASS_APC_HEATING_AND_COOLING_ZONE: Platform.CLIMATE,
    UIWidget.ATLANTIC_PASS_APC_HEATING_ZONE: Platform.CLIMATE,
    UIWidget.ATLANTIC_PASS_APC_ZONE_CONTROL: Platform.CLIMATE,
    UIWidget.DISCRETE_EXTERIOR_HEATING: Platform.SWITCH,
    UIWidget.DOMESTIC_HOT_WATER_PRODUCTION: Platform.WATER_HEATER,
    UIWidget.DOMESTIC_HOT_WATER_TANK: Platform.SWITCH,
    UIWidget.EVO_HOME_CONTROLLER: Platform.CLIMATE,
    UIWidget.HITACHI_AIR_TO_AIR_HEAT_PUMP: Platform.CLIMATE,
    UIWidget.HITACHI_AIR_TO_WATER_HEATING_ZONE: Platform.CLIMATE,
    UIWidget.HITACHI_DHW: Platform.WATER_HEATER,
    UIWidget.MY_FOX_ALARM_CONTROLLER: Platform.ALARM_CONTROL_PANEL,
    UIWidget.MY_FOX_SECURITY_CAMERA: Platform.SWITCH,
    UIWidget.RTD_INDOOR_SIREN: Platform.SWITCH,
    UIWidget.RTD_OUTDOOR_SIREN: Platform.SWITCH,
    UIWidget.RTS_GENERIC: Platform.COVER,
    UIWidget.SIREN_STATUS: None,
    UIWidget.SOMFY_HEATING_TEMPERATURE_INTERFACE: Platform.CLIMATE,
    UIWidget.SOMFY_THERMOSTAT: Platform.CLIMATE,
...
OVERKIZ_UNIT_TO_HA: dict[str, str] = {
    ...
    MeasuredValueType.ELECTRIC_CURRENT_IN_MILLI_AMPERE: (
    ...
    MeasuredValueType.FLOW_IN_LITRE_PER_SECOND: (
        f"{UnitOfVolume.LITERS}/{UnitOfTime.SECONDS}"
    ),
    MeasuredValueType.FLOW_IN_METER_CUBE_PER_HOUR: (
        UnitOfVolumeFlowRate.CUBIC_METERS_PER_HOUR
    ),
    MeasuredValueType.FLOW_IN_METER_CUBE_PER_SECOND: (
        f"{UnitOfVolume.CUBIC_METERS}/{UnitOfTime.SECONDS}"
    ),
